...
package com.bosadeideas.struts2.ejemplos.holamundo.video.example;
...
public class LoginTest extends ConfigTest {
    ...
    public void testLoginConfig() {
        ActionConfig config = assertClass("/example", "Login_input", "com.bosadeideas.struts2.ejemplos.holamundo.video.example.Login");
